...
In this challenge, you are required to sort natural number arrays in either ascend order or descent
order.
...
The `Sort` type should also accept a boolean type. When it is `true`, the sorted result should be in
descent order. Some examples:
