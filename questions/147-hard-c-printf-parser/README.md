...
There is a function in C language: `printf`. This function allows us to print something with
...
and `%f`. For example, if the input string is `"The result is %d."`, the parsed result is a
tuple `['dec']`.
